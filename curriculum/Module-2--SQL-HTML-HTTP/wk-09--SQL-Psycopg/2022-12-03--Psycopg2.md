...
>**NOTE**: If you're getting an error that says something like "role “root” does not exist" use the getpass module and the getpass.getuser() method instead of the os.getlogin() method.  Or simply pass in the result of running 'whoami'
```python
import psycopg2
import os
...
```
Next, let's create a file called `csv_example.py` (from [here](https://github.com/deltaplatoonew/curriculum/blob/master/Module-2--SQL-HTML-HTTP/wk-09--SQL-Psycopg/lecture_materials/sacramento_re_transactions.csv)) and read into the CSV file and clean it up:
```python
import csv
import psycopg2
...
## Challenge
* [Chicago Salaries](https://github.com/deltaplatoonew/city-of-chicago)
